        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="flex flex-col gap-6">
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground leading-tight">
              Forever Preserved in Clear Resin
            </h1>
          ...
          <div className="relative">
            <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl border border-border/50">
              <img
                src="/assets/generated/yorkie-headstone-nabi-v2.dim_600x800.png"
                alt="Headstone memorial with yorkie photo, nameplate reading 'Nabi', grass and pebble stones at base"
